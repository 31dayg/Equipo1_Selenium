...
public class LeftMenuTestCases extends BaseTestCase {
    ...
    public void test1_CategoriaTendenciasOpcionMusica() {
    ...
    public void test2_CategoriaTendenciasOpcionVideojuegos() {
    ...
    public void test3_CategoriaTendenciasOpcionNoticias() {
    ...
    public void test4_CategoriaTendenciasOpcionPeliculas() {
    ...
    public void test5_OpcionSuscripciones() {
    ...
    public void test6_OpcionBiblioteca() {
    ...
    public void test7_OpcionHistorial() {
